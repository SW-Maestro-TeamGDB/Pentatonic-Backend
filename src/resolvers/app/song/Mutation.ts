...
export const uploadFreeSong = async (
    parent: void,
    args: UploadFreeSongInput,
    context: Context
) => {
...
export const updateSong = async (
    ...
    return db
        .collection("song")
        .findOneAndUpdate({ _id }, query, { returnDocument: "after" })
        .then(({ value }) => value)
}

export const uploadInstrument = async (
    parent: void,
    args: UploadInstrumentInput,
    context: Context
) => {
